...
import com.usefullc.solm.common.proxy.nio.*;
 ...
 */
public class ProxyStaticConnectorHandler extends ProxyConnectorHandler {
    ...
    public ProxyStaticConnectorHandler(ByteBuffer buffer, SelectionKey key) {
        super(buffer,key);
...
//            }
            ...
            ProxyTask task = new ProxySaticSocketTask(taskModel);
